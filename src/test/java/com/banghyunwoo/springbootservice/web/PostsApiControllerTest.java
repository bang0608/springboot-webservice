...
import com.banghyunwoo.springbootservice.web.dto.PostsUpdateRequestDto;
...
public class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        List<Posts> postsListAll = postsRepository.findAll();
        assertThat(postsListAll.get(0).getTitle()).isEqualTo(expectedTitle);
        assertThat(postsListAll.get(0).getContent()).isEqualTo(expectedContent);
    }
